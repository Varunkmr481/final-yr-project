...
# BASIC DATA 
# [
# 0:"b'Varun@Student@2025-01-28 23:04:05.761874'"
# 1:"b'Varun@Student@2025-01-28 23:03:38.054381'"
# ]
...
# Initialize logs_data outside the button block
logs_data = None

# Fetch logs when refresh button is clicked
...
if logs_data:
    ...
    st.warning("⚠️ No logs found in the database! Click 'Refresh Report' to reload.")
